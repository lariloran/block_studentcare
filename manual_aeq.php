...
// Card 3 - Perguntas do AEQ
echo html_writer::start_div('manual_aeq-topic', array('onclick' => 'openModal("Perguntas do AEQ", "<p>As perguntas do <strong>AEQ</strong> são elaboradas para medir as emoções dos estudantes em diferentes contextos acadêmicos. Exemplos incluem:</p><ul><li><strong>Durante as aulas</strong>: “Eu me sinto entusiasmado durante as aulas.”</li><li><strong>Durante as provas</strong>: “Eu me sinto ansioso antes de uma prova.”</li><li><strong>Durante o aprendizado</strong>: “Eu me sinto frustrado quando não entendo o conteúdo.”</li></ul>")'));
echo html_writer::tag('div', '📝', array('class' => 'manual_aeq-topic-icon'));
